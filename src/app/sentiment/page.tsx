...
// SENTIMENT (formerly "Sentimentum"). Houses two models under one button:
...
export const metadata = {
  title: "Sentiment — Whitewater",
  description: "Top-down macro read and bottom-up equity read, in one place.",
};
...
export default async function SentimentPage() {
  ...
  return (
    <div>
      <ModuleNav crumb="Sentiment" />
      <main className="mx-auto max-w-5xl px-6 py-8">
        <div className="flex items-baseline gap-3">
          <p className="font-mono text-sm text-accent">// Sentiment</p>
          <span className="font-mono text-xs text-muted">macro + equity read</span>
        </div>
